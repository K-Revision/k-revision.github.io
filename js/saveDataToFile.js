function saveDataToFile() {
    ...
    if (SKForTAKS == 2) {
        ...
        fullDocument.push('<!--Generated by K-Revision-->')
        fullDocument.push('<?instance-generator id="K-Revision XBRL Generator" version="2020.01" creationdate="' + returnDate() + '"?>')
        fullDocument.push('<xbrli:xbrl xml:lang="fo" xmlns:fsa="http://xbrl.dcca.dk/fsa" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:fo-tax="http://www.xbrl.gov.fo/tax" xmlns:gsd="http://xbrl.dcca.dk/gsd" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xlink="http://www.w3.org/1999/xlink">')
        fullDocument.push('<link:schemaRef xlink:type="simple" xlink:href="https://www.vinnugluggin.fo/taxonomy/20180301/FO-entry-IncomeStatementByNature.xsd"/>')
        fullDocument.push('<xbrli:unit id="pure"><xbrli:measure>xbrli:pure</xbrli:measure></xbrli:unit><xbrli:unit id="DKK"><xbrli:measure>iso4217:DKK</xbrli:measure></xbrli:unit>')
    }
